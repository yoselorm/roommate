    ...
    return (
        <div className='w-full sm:mt-[7rem] xl:mt-[4rem] mt-10 px-6 text-black grid md:grid-cols-2 '>
            ...
            <div className='md:ml-6  mb-8 mx-auto md:mt-0 md:hidden '>
                <motion.button onClick={handlePage} variants={herovariants} initial='hidden' animate='visible' className='bg-[#3282B8] p-2 px-8 w-[200px] rounded-[10px] text-xl font-semibold  text-black'>Get Started</motion.button>
            </div>
        </div>
    );
}
