...
const Navbar = () => {
    ...
    return (
        <div className=' flex justify-between px-4 items-center max-w-[1240px] h-24 mx-auto text-black'>
            ...
            <button className='text-black p-2 bg-slate-200 rounded-xl mx-2 font-semibold shadow-xl hover:shadow-2xl hover:text-[#cc3131] cursor-pointer hidden md:flex' onClick={handleLogout}>Logout</button>
